...
rednet.open("right")
local itemNames = {}
local itemsToPauseForRaw = {"oak_leaves","pale_oak_leaves","cherry_leaves","mangrove_leaves","dark_oak_leaves","acacia_leaves","jungle_leaves","birch_leaves","spruce_leaves"}

...
rednet.open("right")
local itemNames = {}
local itemsToPauseForRaw = {"crimson_planks","warped_planks","blackstone","nether_wart_block","neither_brick_fence","nether_brick_slab","crimson_fungus","warped_fungus","shroomlight"}

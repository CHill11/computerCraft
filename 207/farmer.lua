...
local function checkFuel() --make sure there is enough fuel to finish a pass
...
local function harvestAndPlant() --dig plant and replace it
    turtle.digDown()
    if PLANT() then
	print("planting...")
        turtle.placeDown()
...
local function startFarm(width, length)
	for i = 1, width do
        for o = 1, length do
			print(length)
			print("o is " .. o)
